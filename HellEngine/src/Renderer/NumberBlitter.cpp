...
namespace HellEngine
{
	...
	void NumberBlitter::DrawTextBlit(Shader* shader, char* text, int xScreenCoord, int yScreenCoord, float scale, glm::vec3 color, bool leftJustified)
	{
		float screenWidth = 1920; // Have to hard code this coz otherwise the text is the same size in pixels regardless of resolution.
